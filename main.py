...
def parse_args() -> argparse.Namespace:
    ...
    parser = argparse.ArgumentParser(
        ...
        epilog=(
            ...
            "  python -m pruning.main --stage expert_choice    # Выбор экспертов для удаления\n"
    ...
    parser.add_argument(
        "--stage",
        choices=["collect", "profile", "cluster", "expert_choice", "prune"],
        default=None,
        help=(
